...
function ptTag(stato) {
  ...
  return {
    root: {
      class: critico
        ? "inline-flex min-w-[104px] items-center justify-center rounded-full border border-brand-500 bg-brand-500 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-white"
        : "inline-flex min-w-[104px] items-center justify-center rounded-full border border-brand-100 bg-brand-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-brand-700",
    },
  };
}

const ptProgressBar = {
  root: { class: "relative h-1.5 overflow-hidden rounded-full bg-steel-200" },
  value: { class: "h-full rounded-full bg-brand-500 transition-all duration-500" },
  label: { class: "hidden" },
};
          ...
          <div class="mt-5 space-y-4">
            ...
            >
              <div class="flex items-center justify-between gap-4">
                ...
                <Tag :value="entry.stato" :pt="ptTag(entry.stato)" />
              </div>
          ...
          <div class="mt-5 space-y-4">
            ...
            >
              <div class="flex items-center justify-between gap-4">
                ...
                <Tag :value="licenza.canone" :pt="ptTag(licenza.canone)" />
              </div>
              <dl class="mt-3 grid gap-3 text-sm text-steel-700">
                <div>
                  ...
                  <ProgressBar :value="licenza.spazioPerc" :pt="ptProgressBar" class="mt-1.5" />
                </div>
                <div>
                  <div class="flex items-center justify-between gap-4">
                    <dt>Utenti</dt>
                  ...
                  <ProgressBar :value="licenza.utentiPerc" :pt="ptProgressBar" class="mt-1.5" />
                </div>
                <div class="flex items-center justify-between gap-4">
                  <dt>Scadenza</dt>
